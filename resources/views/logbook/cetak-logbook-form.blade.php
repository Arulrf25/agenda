...
<head>
    <title>Cetak Bulanan Data Tamu</title>
    {{-- Link CSS Bootstrap  --}}
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="container">
        <div class="car-body">
            ...
            <div class="input-group mb-3">
                <a href="#" onclick="this.href='/logbook/cetak-logbook-pertanggal/'+document.getElementById('tglawal').value + '/' + document.getElementById('tglakhir').value" target="_blank" class="btn btn-primary col-md-12"> Cetak Laporan Pertanggal <i class="fas fa-print"></i></a>
            </div>
        </div>
    </div>
    </div>
