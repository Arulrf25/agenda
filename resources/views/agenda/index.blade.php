...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <nav class="main-header navbar navbar-expand navbar-dark bg-primary">
        <div class="wrapper">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" data-widget="pushmenu" href="#" role="button"><i class="fas fa-bars"> DATA KEGIATAN</i></a>
                </li>
                <!-- icons laptop / link dashboard -->
                    ...
                    <li class="nav-item">
                        <a type="button" class="nav-link fas fa-file-download" href="{{route('agenda.cetak')}}" target="_blank"></a>
                    </li>
                    <li class="nav-item">
                        <a type="button" class="nav-link fas fa-print" href="{{route('agenda.cetak-agenda-form')}}"></a>
                    </li>
    ...
    <div class="container">
        ...
        <table class="table table-striped table-hover" style="vertical-align: middle">
            ...
            <tr>
                ...
                <td>
                    <a href="{{route('agenda.edit', $agenda->id)}}" class="btn btn-primary fas fa-edit"></a>
